...
console.assert(text.startsWith('[2026. 8. 26. / 1호점]'), '헤더 포맷 불일치');
...
const textNoBranch = buildOrderShareText(cart, products, null, date);
console.assert(textNoBranch.startsWith('[2026. 8. 26.]'), '매장 미선택 시 헤더 포맷 불일치');
